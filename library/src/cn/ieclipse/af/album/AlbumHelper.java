...
public class AlbumHelper {
    ...
    void getAlbum() {
        ...
        Cursor cursor = mResolver.query(Albums.EXTERNAL_CONTENT_URI, projection, null, null, null);
    ...
    String getOriginalImagePath(String image_id) {
        ...
        Cursor cursor = mResolver.query(Media.EXTERNAL_CONTENT_URI, projection, Media._ID + "=" + image_id, null, null);
        if (cursor != null) {
            cursor.moveToFirst();
