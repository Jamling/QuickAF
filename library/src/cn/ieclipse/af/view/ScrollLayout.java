 ...
 *
 * @author jamling, Yao.GUET blog: http://blog.csdn.net/Yao_GUET date: 2011-05-04
 */
public class ScrollLayout extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            mSnapVelocity = a.getInt(R.styleable.ScrollLayout_af_snapVelocity, SNAP_VELOCITY);
    ...
    public void snapToScreen(int whichScreen) {
        ...
        if (getScrollX() != (whichScreen * getWidth())) {
            ...
            if (mScreenChangeListener != null) {
                ...
                mScreenChangeListener.onScreenChange(mCurScreen, mCurScreen < count - 1, mCurScreen > 0);
            }
        }
    }
