...
import cn.ieclipse.af.view.BadgeView3;
...
public class RadioButtonBadgeViewActivity extends SampleBaseActivity
    ...
    protected void initContentView(View view) {
        ...
        badgeView3 = new BadgeView3(view.getContext());
        badgeView3.setTextSize(ts);
        badgeView3.setMax(10, null);
        badgeView3.setTargetView(tv1);
        badgeView3.setBadgeBackground(ts >> 1, 0xffff0000);
    ...
    public void onClick(View v) {
        if (v == btn1) {
            ...
            badgeView3.incrementBadgeCount(1);
        }
        else if (v == btn2) {
            ...
            badgeView3.decrementBadgeCount(1);
        }
        super.onClick(v);
    }
